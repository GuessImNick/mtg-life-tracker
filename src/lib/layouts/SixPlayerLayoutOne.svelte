...
<div class="flex flex-col h-full justify-between">
	<div class="h-6 flex flex-col gap-2" class:h-[66%]={!$appState.isMenuOpen}>
	...
	<div class="h-6 flex flex-col gap-2" class:h-[33%]={!$appState.isMenuOpen}>
		<div class="h-full w-full flex justify-between gap-2">
			<div class="w-1/2">
				<Player orientation="right" playerData={players[0]} />
			</div>
			<div class="w-1/2">
				<Player orientation="left" playerData={players[5]} />
			</div>
		</div>
	</div>
</div>
