...
<div class="flex flex-col h-full justify-between">
	<div class="h-6 flex flex-col gap-2" class:h-[70%]={!isMenuOpen}>
		<div class="h-full w-full flex justify-between gap-2">
			<div class="w-1/2">
				<Player orientation="right" playerData={players[2]} {isMenuOpen} />
			</div>
			<div class="w-1/2">
		...
		<div class="h-full w-full flex justify-between gap-2">
			...
			<div class="w-1/2">
				<Player orientation="left" playerData={players[4]} {isMenuOpen} />
			</div>
		</div>
	</div>
	<div class="flex-grow">
	...
	<div class="h-6 flex items-end" class:h-[30%]={!isMenuOpen}>
